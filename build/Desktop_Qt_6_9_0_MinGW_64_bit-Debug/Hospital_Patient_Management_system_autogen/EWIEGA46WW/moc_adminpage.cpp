...
template <> constexpr inline auto AdminPage::qt_create_metaobjectdata<qt_meta_tag_ZN9AdminPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_listUsersButton_clicked'
...
void AdminPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_listUsersButton_clicked(); break;
        case 3: _t->on_deleteUserButton_clicked(); break;
        case 4: _t->on_logoutButton_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdminPage::*)()>(_a, &AdminPage::logoutRequested, 0))
            return;
    }
}
